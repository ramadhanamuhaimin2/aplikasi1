    ...
    <div class="row">
      ...
      <div class="col-md-8 order-md-1">
        ...
        <form class="needs-validation" novalidate method="POST" action="">
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <input type="text" class="form-control" name="nama" id="name" placeholder="" value="name" required>
          ...
          <div class="mb-3">
            <label for="address">Tanggal Keberangkatan</label>
          ...
          <div class="row">
            <div class="col-md-5 mb-3">
              <label for="nama_ka">Nama KA</label>
              <select class="custom-select d-block w-100" name="nama_ka" required>
        ...
        <div class="custom-control custom-checkbox">
          ...
          <hr class="mb-4">
          <button class="btn btn-primary btn-lg btn-block" type="submit" name="pesan">Pesan</button>
        </form>
      </div>
    </div>
